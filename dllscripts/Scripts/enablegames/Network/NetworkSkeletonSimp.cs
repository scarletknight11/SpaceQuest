...
{
	[AddComponentMenu("Network/NetworkSkeletonSimp")]
//	[NetworkSettings(channel=2)]
	public class NetworkSkeletonSimp : NetworkBehaviour
	{
...
//			print ("SendTransform");
		...
		static internal void HandleSkeleton(NetworkMessage netMsg)
		{
			...
			NetworkSkeletonSimp sk = foundObj.GetComponent<NetworkSkeletonSimp>();
			if (sk == null)
			{
