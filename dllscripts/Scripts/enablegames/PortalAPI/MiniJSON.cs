...
public class MiniJSON {
	...
	protected static bool serializeObjectDictionary(Dictionary<string, object> dict, StringBuilder builder) {
		builder.Append("{");
	...
	protected static bool serializeValue(object value, StringBuilder builder) {
		...
		if (value == null) {
			...
			serializeObjectDictionary((Dictionary<string, object>)value, builder);
